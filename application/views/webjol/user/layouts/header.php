...
<head>
    ...
    <link href="<?php echo base_url('assets/css/footer/footer2.css'); ?>" rel="stylesheet">
                            ...
                            <li class="language">
                                <div class="btn-group languages-block ">
                                    <form action="https://demo.smartaddons.com/templates/html/supermarket/index.html" method="post" enctype="multipart/form-data" id="bt-language">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a href="index.html"><img class="image_flag" src="<?php echo base_url('assets/image/catalog/flags/gb.png'); ?>" alt="English" title="English" /> English </a></li>
                                            <li> <a href="html_with_RTL/home2.html"> <img class="image_flag" src="<?php echo base_url('assets/image/catalog/flags/ar.png'); ?>" alt="Arabic" title="Arabic" /> Arabic </a> </li>
                                        </ul>
                                    </form>
                                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-logo col-lg-3 col-md-3 col-sm-12 col-xs-12">
                    <div class="logo"><a href="#"><img src="<?php echo base_url('assets/image/catalog/logo2.png'); ?>" title="Your Store" alt="Your Store" /></a></div>
                </div>
                <!-- //end Logo -->
                <!-- Search -->
                                                ...
                                                <ul class="megamenu">
                                                    <li class="item-vertical  with-sub-menu hover">
                                                        ...
                                                        <a href="#" class="clearfix">
                                                            <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico10.png');?>" alt="icon">
                                                    ...
                                                    <li class="item-vertical">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                            <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico1.png');?>" alt="icon">
                                                    ...
                                                    <li class="item-vertical  style1 with-sub-menu hover">
                                                        ...
                                                        <a href="#" class="clearfix">
                                                            ...
                                                            <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico9.png');?>" alt="icon">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="row banner">
                                                                            <a href="#">
                                                                                <img src="<?php echo base_url('assets/image/catalog/menu/megabanner/vbanner1.jpg');?>" alt="banner1">
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <li class="item-vertical with-sub-menu hover">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico7.png');?>" alt="icon">
                                                    ...
                                                    <li class="item-vertical css-menu with-sub-menu hover">
                                                        ...
                                                        <a href="#" class="clearfix">
                                                             ...
                                                             <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico6.png');?>" alt="icon">
                                                    ...
                                                    <li class="item-vertical">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico5.png');?>" alt="icon">
                                                            <span>Health & Beauty</span>
                                                    ...
                                                    <li class="item-vertical">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico4.png');?>" alt="icon">
                                                            <span>Bathroom</span>
                                                        </a>
                                                    </li>
                                                    <li class="item-vertical">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico3.png');?>" alt="icon">
                                                    ...
                                                    <li class="item-vertical" >
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                            <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico2.png');?>" alt="icon">
                                                            <span>Bedroom</span>
                                                        </a>
                                                    </li>
                                                    <li class="item-vertical" >
                                                    ...
                                                    <li class="item-vertical" style="display: none;">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico11.png'); ?>" alt="icon">
                                                    ...
                                                    <li class="item-vertical" style="display: none;">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                             <img src="<?php echo base_url('assets/image/catalog/menu/icons/ico12.png'); ?>" alt="icon">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <!-- <div class="col-md-15">
                                                                    <a href="#" class="image-link"> 
                                                                        <span class="thumbnail">
                                                                            <img class="img-responsive img-border" src="" alt="">
